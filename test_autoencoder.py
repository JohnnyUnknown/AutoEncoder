...
file_model = Path(path[0] + "/model_256_160p_mse_0.keras")
autoencoder_model = load_model(file_model)
# autoencoder_model.summary()
    


test_img1 = load_and_preprocess(IMAGE_DIR / "g_ (7)_rotated_90_flipped.jpg")
test_img1 = np.expand_dims(test_img1, axis=0)
    
test_img2 = load_and_preprocess(IMAGE_DIR / "g_ (7)_rotated_270_flipped.jpg")
test_img2 = np.expand_dims(test_img2, axis=0)   
 
test_img3 = load_and_preprocess(IMAGE_DIR / "g_ (12)_rotated_180_channels_permuted.jpg")
test_img3 = np.expand_dims(test_img3, axis=0)

test_img4 = load_and_preprocess(IMAGE_DIR / "y_ (7)_rotated_0.jpg")
...
print("MSE:")
print("Повернутые однородные изображения: ", distance_1)
print("Разные однородные изображения: ", distance_2)
print("Разные разнородные изображения: ", distance_3, "\n")
